...
public interface RequirementRepository extends JpaRepository<Requirement, Long> {
    ...
    @Query("select r from Requirement r where r.submitter.id = :userId or r.customer.id = :userId or r.assignee.id = :userId " +
           "or r.project.manager.id = :userId order by r.createdAt desc")
