...
const en: Record<string, string> = {
  ...
  '里程碑名称': 'Milestone name', '目标日期时间': 'Target date/time', '保存里程碑': 'Save milestone',
  '所属里程碑': 'Milestone', '上级任务': 'Parent task', '无（顶级任务）': 'None (top-level task)',
  '变更任务状态': 'Change task status', '解除阻塞': 'Unblock', '提交验收': 'Submit acceptance',
  '标记阻塞': 'Mark blocked', '取消任务': 'Cancel task', '重新打开': 'Reopen', '已停止执行': 'Execution stopped',
  '请填写状态变更原因': 'Enter a reason for this status change',
